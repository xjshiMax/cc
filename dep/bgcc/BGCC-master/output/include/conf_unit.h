...
public:
    ...
    void set_value(int64_t l);

    /**
     * @brief is_null 判断配置单元是否为null类型
     *
     * @return
     * @see
     * @note
...
private:
    ...
    static ConfUnit _null;

private:
    ConfUnit(const ConfUnit&);
    ConfUnit& operator=(const ConfUnit&);
}; // end of class ConfUnit
} // bgcc2
